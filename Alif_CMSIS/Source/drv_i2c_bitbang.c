...
#define i2c_delay() PMU_delay_loop_us(3)
#define i2c_half_delay() PMU_delay_loop_us(2)
//#define I2C_TIMEOUT_MS	40

volatile int started = 0;
//extern volatile uint32_t ms_ticks;

void i2c_init () {
  printf("initting bitbang i2c...\r\n");
  ...
  printf("initting bitbang i2c OK\r\n");
}
