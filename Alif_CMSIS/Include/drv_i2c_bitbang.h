...
#if 1//defined(BOARD_IS_ALIF_APPKIT_ALPHA1_VARIANT)
...
#elif 0//defined(BOARD_IS_ALIF_APPKIT_ALPHA2_VARIANT)
/*  Tessolve Development Board Revised
 *  P2_6 -> SDA
 *  P2_7 -> SCL
 */
#define BITBANG_BASE	GPIO2_BASE
...
/* GPIO Port and Pin Number for SDA/SCL. */
#define PINMUX_SDA_PORT_NUMBER         PORT_NUMBER_2
#define PINMUX_SDA_PIN_NUMBER          PIN_NUMBER_6

#define PINMUX_SCL_PORT_NUMBER         PORT_NUMBER_2
#define PINMUX_SCL_PIN_NUMBER          PIN_NUMBER_7
#else
